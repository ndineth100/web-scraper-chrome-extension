...
function extensionListener(request, sender, sendResponse, options) {
  ...
  console.log('extension/content_script/content_scraper.js:8:14:\'chrome.runtime.onMessage\',request', 'chrome.runtime.onMessage', request);

  if (request.extractData) {
    console.log('extension/content_script/content_scraper.js:11:16:\'received data extraction request\',request', 'received data extraction request', request);
    var extractor = new DataExtractor(request, { $, window, document });
    var deferredData = extractor.getData();
    deferredData.done(function (data) {
      console.log('extension/content_script/content_scraper.js:15:18:\'dataextractor data\',data', 'dataextractor data', data);
      sendResponse(data);
    });
    return true;
  } else if (request.previewSelectorData) {
    console.log('extension/content_script/content_scraper.js:20:16:\'received data-preview extraction request\',request', 'received data-preview extraction request', request);
    ...
    deferredData.done(function (data) {
      console.log('extension/content_script/content_scraper.js:24:18:\'dataextractor data\',data', 'dataextractor data', data);
      sendResponse(data);
    });
    return true;
  }
  // Universal ContentScript communication handler
      ...
      console.log('extension/content_script/content_scraper.js:33:16:\'received ContentScript request\',request', 'received ContentScript request', request);
...
},{"./../scripts/DataExtractor":8,"./../scripts/getContentScript":27}],4:[function(require,module,exports){
...
},{"./content_scraper":3,"jquery":33}],5:[function(require,module,exports){
var jquery = require('jquery-deferred');
/**
...
},{"jquery-deferred":29}],6:[function(require,module,exports){
...
},{"./ContentSelector":7,"jquery-deferred":29}],7:[function(require,module,exports){
...
},{"./ElementQuery":9,"css-selector":28,"jquery-deferred":29}],8:[function(require,module,exports){
...
},{"../assets/jquery.whencallsequentially":2,"./SelectorList":22,"./Sitemap":24,"jquery-deferred":29}],9:[function(require,module,exports){
/**
...
},{"./ElementQuery":9,"./Selectors":23,"jquery-deferred":29}],11:[function(require,module,exports){
var jquery = require('jquery-deferred');
...
},{"./../ElementQuery":9,"./../UniqueElementList":25,"css-selector":28,"jquery-deferred":29}],14:[function(require,module,exports){
var jquery = require('jquery-deferred');
...
},{"../../assets/base64":1,"../../assets/jquery.whencallsequentially":2,"jquery-deferred":29}],18:[function(require,module,exports){
var jquery = require('jquery-deferred');
var whenCallSequentially = require('../../assets/jquery.whencallsequentially');
...
},{"../../assets/jquery.whencallsequentially":2,"css-selector":28,"jquery-deferred":29}],20:[function(require,module,exports){
var jquery = require('jquery-deferred');
...
},{"./BackgroundScript":5,"jquery-deferred":29}],27:[function(require,module,exports){
...
},{"./jquery-callbacks.js":30}],33:[function(require,module,exports){
/*!
